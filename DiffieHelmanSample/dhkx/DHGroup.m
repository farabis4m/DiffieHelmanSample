...
+ (DHGroup *)groupWithPrimeString:(NSString *)p
                   generateString:(NSString *)g
{
    DHGroup *group = [[DHGroup alloc] initWithPrime:bigNumberFromDecimalString(p)
                                          generator:bigNumberFromDecimalString(g)];
    return [group autorelease];
}
